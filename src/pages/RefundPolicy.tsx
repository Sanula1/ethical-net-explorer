...
const RefundPolicy = () => {
  ...
  const sections = [
    { id: "general-rule", title: "General Refund Rule", level: 1 },
    { id: "subscriptions", title: "Subscription Payments", level: 1 },
    { id: "monthly-subs", title: "Monthly Subscriptions", level: 2 },
    { id: "yearly-subs", title: "Yearly Subscriptions", level: 2 },
    { id: "ads-custom", title: "Advertisements & Custom Services", level: 1 },
    { id: "humanitarian", title: "Humanitarian Exceptions", level: 1 },
    { id: "eligible-situations", title: "Eligible Situations", level: 2 },
    { id: "requirements", title: "Requirements", level: 2 },
    { id: "management-decision", title: "Management Decision Authority", level: 1 },
    { id: "payment-security", title: "Payment Security & Official Channels", level: 1 },
              ...
              <p className="text-sm text-muted-foreground mt-2">
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                  <p className="text-lg leading-relaxed text-muted-foreground mb-8">
                    At <strong>Suraksha LMS</strong>, we value transparency in our financial practices. Please read our Refund Policy carefully before making any payments.
                  </p>

                   <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg mb-8">
                     <p className="text-black font-medium m-0">
                       <strong>Important:</strong> All payments made to Suraksha LMS are generally non-refundable. Please review this policy before completing any transaction.
                     </p>
                   </div>
                  ...
                  <div className="space-y-12">
                    <section id="general-rule" className="scroll-mt-24">
                      ...
                      <div className="space-y-6">
                        <p className="text-gray-700">All payments made to Suraksha LMS are <strong className="text-black">non-refundable</strong>, including:</p>
                      ...
                      <div className="space-y-6">
                        <div className="bg-secondary/10 rounded-lg p-6">
                          ...
                          <p className="text-muted-foreground m-0">
                            Suraksha LMS reserves the absolute right to approve or reject any refund request. Our decision is final and not subject to appeal.
                          </p>
                        </div>
                    ...
                    <section id="payment-security" className="scroll-mt-24">
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                       ...
                       <div className="mt-6 p-4 bg-gray-200 border border-gray-400 rounded-lg">
                         <p className="text-sm text-gray-700 m-0">
                           <strong className="text-black">Warning:</strong> Payments made through unofficial channels are entirely at your own risk. We cannot guarantee service delivery or provide refunds for such transactions.
                         </p>
                       </div>
                    </section>
                       ...
                       <div className="bg-gray-100 rounded-lg p-6">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-3">
                            <span className="text-sm text-muted-foreground">Financial Support:</span>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <strong className="text-foreground">service@lms.suraksha.lk</strong>
                          </div>
                        </div>
                      </div>
                    </section>
                  ...
                  <div className="mt-12 pt-8 border-t text-center">
                    <p className="text-sm text-muted-foreground">
                      © 2024 Suraksha LMS. Transparent financial policies.<br />
