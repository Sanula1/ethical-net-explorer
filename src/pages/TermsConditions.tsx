...
const TermsConditions = () => {
  ...
  const sections = [
    { id: "ownership", title: "Ownership & Operation", level: 1 },
    { id: "eligibility", title: "Eligibility & Access", level: 1 },
    { id: "user-responsibilities", title: "User Responsibilities", level: 1 },
    { id: "required-conduct", title: "Required Conduct", level: 2 },
    { id: "prohibited-activities", title: "Prohibited Activities", level: 2 },
    { id: "termination", title: "Termination & Liability", level: 1 },
    { id: "account-termination", title: "Account Termination", level: 2 },
    { id: "data-breach", title: "Data Breach Penalties", level: 2 },
                  ...
                  <div className="space-y-12">
                    <section id="ownership" className="scroll-mt-24">
                      <h2 className="text-2xl font-bold text-foreground mb-6 pb-2 border-b">1. Ownership & Operation</h2>
                         <div className="bg-gray-50 rounded-lg p-6">
                          ...
                          This platform is owned and operated by <strong>Suraksha Education Services</strong>, Sri Lanka, under legal registration <strong>[Registration Number]</strong>.
                        </p>
                      </div>
                    </section>
                    ...
                    <section id="contact" className="scroll-mt-24">
                      <h2 className="text-2xl font-bold text-foreground mb-6 pb-2 border-b">Contact Information</h2>
                       <div className="bg-gray-100 rounded-lg p-6">
                         <p className="text-gray-700 mb-4">For questions about our Terms & Conditions, contact our legal team at:</p>
