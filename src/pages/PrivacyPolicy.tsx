...
const PrivacyPolicy = () => {
  ...
  const sections = [
    { id: "data-collection", title: "Data We Collect", level: 1 },
    { id: "personal-data", title: "Personal Data", level: 2 },
    { id: "educational-data", title: "Educational Data", level: 2 },
    { id: "security-data", title: "Security Data", level: 2 },
    { id: "usage-data", title: "Usage Data", level: 2 },
    { id: "data-usage", title: "How We Use Your Data", level: 1 },
    { id: "primary-uses", title: "Primary Uses", level: 2 },
    { id: "secondary-uses", title: "Secondary Uses", level: 2 },
    { id: "data-sharing", title: "Data Sharing & Third Parties", level: 1 },
    { id: "trusted-partners", title: "Trusted Partners", level: 2 },
    { id: "educational-access", title: "Educational Access", level: 2 },
    { id: "data-retention", title: "Data Retention & Deletion", level: 1 },
    { id: "security-measures", title: "Security Measures", level: 1 },
    { id: "user-rights", title: "Your Rights & Controls", level: 1 },
              ...
              <p className="text-sm text-muted-foreground mt-2">
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                  <p className="text-lg leading-relaxed text-muted-foreground mb-8">
                    At <strong>Suraksha LMS</strong>, protecting your privacy and data security is our top priority. This policy explains how we collect, use, and safeguard your information.
                  </p>
                    ...
                    <section id="data-retention" className="scroll-mt-24">
                      ...
                      <div className="overflow-hidden rounded-lg border">
                       ...
                       <div className="mt-6 p-4 bg-gray-100 rounded-lg">
                         <p className="text-sm text-gray-700 m-0">
                           <strong>Note:</strong> Backup copies may remain for audit, legal compliance, and security purposes. Contact <strong>service@lms.suraksha.lk</strong> for deletion requests.
                         </p>
                       </div>
                    </section>
                    ...
                    <section id="user-rights" className="scroll-mt-24">
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                       ...
                       <div className="mt-6 p-4 bg-gray-100 rounded-lg text-center">
                         <p className="text-sm text-gray-700 m-0">
                           To exercise any of these rights, contact our support team at <strong>service@lms.suraksha.lk</strong>
                         </p>
                       </div>
                    </section>
                       ...
                       <div className="bg-gray-100 rounded-lg p-6">
                         ...
                         <div className="space-y-2">
                           <div className="flex items-center gap-3">
                             ...
                             <strong className="text-black">service@lms.suraksha.lk</strong>
                           </div>
                           <div className="flex items-center gap-3">
                             <span className="text-sm text-gray-700">Privacy Officer:</span>
                  ...
                  <div className="mt-12 pt-8 border-t text-center">
                    <p className="text-sm text-muted-foreground">
                      © 2024 Suraksha LMS. All rights reserved.<br />
